...
public class SourceReader {
    ...
    private ArrayList<String> sourceText;  // stores the source program here. 
/*
...
*/
    ...
    /**Prints out all of the source code encountered up till when 
     * the function was called
     */
   
    public void printSource(){
        for ( int i=0; i<sourceText.size(); i++){
            String line  = sourceText.get(i);
